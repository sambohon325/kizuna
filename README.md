...
1. Migrate render workloads onto the durable job contract; AI Crew proposals, Sound Producer voice generation, media transfer, storage audits, and production backups now use the shared ledger
