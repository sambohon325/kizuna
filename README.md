...
1. Migrate remaining render workloads onto the durable job contract; Scene Compositor motion previews, AI Crew proposals, Sound Producer voice generation, media transfer, storage audits, and production backups now use the shared ledger
