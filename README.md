...
1. Migrate voice execution and render workloads onto the durable job contract; AI Crew proposals, media transfer, storage audits, and production backups now use the shared ledger
