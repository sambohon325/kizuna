...
Kizuna Studio is a browser-based, AI-assisted anime production workspace. This first vertical slice manages productions, Creative DNA style bibles, scenes, and shots. It is intentionally model-provider agnostic so local and hosted generation engines can be added without changing the editor.
...
1. Script and outline assistant with provider adapters
