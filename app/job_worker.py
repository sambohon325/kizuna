...
from app.main import execute_crew_proposal_job, execute_crew_voice_job, execute_project_backup_job, execute_shot_motion_render_job, execute_timeline_render_job, mark_crew_job_failed, mark_project_backup_failed, mark_shot_motion_job_failed, mark_timeline_render_job_failed
from app.schema_migrations import migrate_database


HANDLERS = {"media.proxy": execute_media_proxy_job, "maintenance.storage-audit": execute_storage_audit_job, "maintenance.backup": execute_project_backup_job, "crew.proposal": execute_crew_proposal_job, "crew.voice": execute_crew_voice_job, "render.shot-motion": execute_shot_motion_render_job, "render.animatic": execute_timeline_render_job, "render.master": execute_timeline_render_job}
