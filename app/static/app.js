...
let integrationSettings=null,aiRoutingSettings=null;
...
async function openSettings() {
  ...
  try{[integrationSettings,aiRoutingSettings]=await Promise.all([api('/api/settings/integrations'),api('/api/settings/ai-routing')]);renderIntegrationSettings();}catch(error){host.innerHTML=`<div class="job-error">${safe(error.message)}</div>`;}
}
