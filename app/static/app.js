...
async function setupStorageConsole(projectId) {
  ...
  try {
    const [policy,schedule,storage,backups,links,studio]=await Promise.all([api(`/api/projects/${projectId}/storage-policy`),api(`/api/projects/${projectId}/backup-schedule`),api('/api/settings/storage'),api(`/api/projects/${projectId}/backups`),api(`/api/projects/${projectId}/delivery-links`),api(`/api/projects/${projectId}/compositor`)]);
