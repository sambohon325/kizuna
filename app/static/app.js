...
let integrationSettings=null,aiRoutingSettings=null,computeSettings=null,storageSettings=null,professionalProfile=null,settingsView='compute';
...
async function openSettings() {
  ...
  try{[integrationSettings,aiRoutingSettings,computeSettings,storageSettings,professionalProfile]=await Promise.all([api('/api/settings/integrations'),api('/api/settings/ai-routing'),api('/api/settings/compute'),api('/api/settings/storage'),api('/api/settings/creator-profile')]);renderIntegrationSettings();}catch(error){host.innerHTML=`<div class="job-error">${safe(error.message)}</div>`;}
}
