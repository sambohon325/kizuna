...
function renderAssetLibrary(){
  ...
  document.querySelector('#asset-summary').textContent=`${filtered.length} of ${groups.length} assets · ${activeAssetLibrary.summary.versions} saved versions`;
...
function renderAssetInspector(){
  ...
  if(!group){host.innerHTML='<div class="asset-inspector-empty">Select an asset to see its details and versions.</div>';return;}
