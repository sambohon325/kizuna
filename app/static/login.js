...
let setup=false,invitationToken='';
async function initialize(){
  ...
  if(invitationToken){
    ...
    form.elements.email.closest('label').hidden=true;form.elements.email.required=false;form.elements.password.autocomplete='new-password';return;
  }
