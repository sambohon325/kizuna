...
const helpArticles=[
  ...
  {id:'ai-help',category:'AI & automation',title:'Choose how much AI help you want',summary:'Work manually, delegate individual crafts, or let the AI Crew coordinate reviewable steps.',steps:['Open AI Crew from the left rail.','Choose Guided for proposals you approve, Autopilot for delegated execution, or Manual.','Open a department only when you want to change its role or engine.','Review every proposed action in Activity & approvals.','Use the floating AI button for contextual help on the workspace currently visible.'],tip:'Guided is the safest starting point. Kizuna keeps AI work visible, editable, and attributable.'},
